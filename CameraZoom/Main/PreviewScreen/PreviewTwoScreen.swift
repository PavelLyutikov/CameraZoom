...
class PreviewTwoScreen: UIViewController {
...
//        }
        ...
        title.text = NSLocalizedString("Используйте свою камеру для макро съемки, приближайте мелкие объекты и детали для фото.", comment: "Описание макросъемки")
...
//        }
        ...
        title.attributedText = NSAttributedString(string: NSLocalizedString("МАКРОСЪЕМКА", comment: "Макросъемка"), attributes:
